...
/*
<h6>Brand Logo Variants</h6><div class="d-flex"></div>
...
(function ($) {
  ...
  function _createSkinBlock(colors, callback, noneSelected) {
  	var $block = $('<div />', {class: 'd-flex flex-wrap mb-3'})
  ...
  $container.append(
    '<h5>Customize TX-MIS</h5><hr class="mb-2"/>'
  )
...
/*
	// Test Variants
	$container.append('<h6>Test Variants</h6>')
	var $test_variants = $('<div />', {
		class: 'd-flex'
	})
	var test_all_colors = navbar_dark_skins.concat(navbar_light_skins)
	var $test_variants_colors = _createSkinBlock(test_all_colors, function () {
		var color = $(this).data('color')
    var $main_header = $('.main-header')
    $main_header.removeClass('navbar-dark').removeClass('navbar-light')
    test_all_colors.forEach(function (color) {
	...
	var active_test_color = null
	
	$('.main-header')[0].classList.forEach(function (className) {
    if (test_all_colors.indexOf(className) > -1 && active_test_color === null) {
      active_test_color = className.replace('navbar-', 'bg-')
    }
  })
  
	$test_variants.append($test_variants_colors)
	$container.append($test_variants)
	*/
  ...
  var $navbar_variants_colors = _createSkinBlock(navbar_all_colors, function () {
    var color = $(this).data('color')
    var $main_header = $('.main-header')
    $main_header.removeClass('navbar-dark').removeClass('navbar-light')
  ...
  $container.append(_createSkinBlock(accent_colors, function () {
    var color = $(this).data('color')
  ...
  var $sidebar_dark_variants = _createSkinBlock(sidebar_colors, function () {
    var color = $(this).data('color')
  ...
  var $sidebar_light_variants = _createSkinBlock(sidebar_colors, function () {
    var color = $(this).data('color')
  ...
  var $brand_variants = _createSkinBlock(logo_skins, function () {
    var color = $(this).data('color')
    var $logo = $('.brand-link')
